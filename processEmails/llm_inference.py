...
class Model:
    def __init__(self):
        ...
        self.hypothesis_class_lst = list(Config.hypothesis_class_label_dic.values())
    ...
    def predict(self, text):
        pipe_output = self.pipe_classifier(
                        text,
                        candidate_labels=self.hypothesis_class_lst,
                        hypothesis_template="{}",
                        multi_label=False,
        ...
        hypothesis_label_dic_inference_inverted = {value: key for key, value in Config.hypothesis_class_label_dic.items()}
